...
import { textAMO, textBRANCH, textJAL, textJALR, textLOAD, textMISC_MEM_FENCE, textMISC_MEM_FENCE_I, textMISC_MEM_LOAD, textOP, textOP_FP, textOP_IMM, textOP_IMM_Shift, textR4, textSTORE, textSYSTEM_TRAP, textSYSTEM_ZICSR, textUType } from './Texts.js';
...
export class Decoder {
  ...
  binFrags;
  /**
    * Steps for decoding an instruction in the order they are executed
    *  Each index contains a tuple of two strings.
    * @type {Frag[]}
    */
  binFragsOrdered;

 /**
    *  Decode steps array. each element is a new section. Each section contains an array of tuples.
    *  The first element is the heading
    * @type {String[]}
    */
 decodeSteps;
  ...
  constructor(bin, config, xlens = undefined) {
    ...
    // Create an array of decode steps
    this.binFragsOrdered = [];
    this.decodeSteps = [];
  ...
  #decodeOP() {
    ...
    // Steps for decoding in order
    this.binFragsOrdered.push(f['opcode'], f['funct3'], f['funct7'], f['rd'], f['rs1'], f['rs2']);

    // Explanation of the decode steps
    this.decodeSteps = textOP(
      this.binFrags,
      this.binFragsOrdered,
      ISA[this.#mne].fmt,
      ISA[this.#mne].isa,
  ...
  #decodeOP_FP() {
    ...
    // Steps for decoding in order
    this.binFragsOrdered.push(f['opcode'], f['fmt'], f['funct5'], f['funct3'], f['rd'], f['rs1'], f['rs2']);

    // Explanation of the decode steps
    this.decodeSteps = textOP_FP(
      this.binFrags,
      this.binFragsOrdered,
      ISA[this.#mne].fmt,
      ISA[this.#mne].isa,
  ...
  #decodeJALR() {
    ...
    // Steps for decoding in order
    this.binFragsOrdered.push(f['opcode'], f['funct3'], f['rd'], f['rs1'], f['imm']);

    // Explanation of the decode steps
    this.decodeSteps = textJALR(
      this.binFrags,
      this.binFragsOrdered,
      ISA[this.#mne].fmt,
      ISA[this.#mne].isa,
  ...
  #decodeOP_IMM() {
    ...
    if (shift) {
      ...
      // Steps for decoding in order
      this.binFragsOrdered.push(f['opcode'], f['funct3'], f['rs1'], f['rd'], f['shift'], f['imm']);

      // Explanation of the decode steps
      this.decodeSteps = textOP_IMM_Shift(
        this.binFrags,
        this.binFragsOrdered,
        ISA[this.#mne].fmt,
        ISA[this.#mne].isa,
      ...
      // Steps for decoding in order
      this.binFragsOrdered.push(f['opcode'], f['funct3'], f['rs1'], f['rd'], f['imm']);

      // Explanation of the decode steps
      this.decodeSteps = textOP_IMM(
        this.binFrags,
        this.binFragsOrdered,
        ISA[this.#mne].fmt,
        ISA[this.#mne].isa,
  ...
  #decodeMISC_MEM() {
    ...
    if (loadExt) {
      ...
      // Explanation of the decode steps
      this.decodeSteps = textMISC_MEM_LOAD(
        this.binFrags,
        this.binFragsOrdered,
        ISA[this.#mne].fmt,
        ISA[this.#mne].isa,
      ...
      // Steps for decoding in order
      this.binFragsOrdered.push(f['opcode'], f['fm'], f['pred'], f['succ'], f['rd'], f['rs1'], f['imm']);

      // Explanation of the decode steps
      this.decodeSteps = textMISC_MEM_FENCE(
        this.binFrags,
        this.binFragsOrdered,
        ISA[this.#mne].fmt,
        ISA[this.#mne].isa,
      ...
      // Steps for decoding in order
      this.binFragsOrdered.push(f['opcode'], f['imm'], f['rs1'], f['rd'], f['funct3']);

      // Explanation of the decode steps
      this.decodeSteps = textMISC_MEM_FENCE_I(
        this.binFrags,
        this.binFragsOrdered,
        ISA[this.#mne].fmt,
        ISA[this.#mne].isa,
  ...
  #decodeSYSTEM() {
    ...
    if (trap) {
      ...
      // Steps for decoding in order
      this.binFragsOrdered.push(f['opcode'], f['funct3'], f['funct12'], f['rs1'], f['rd']);

      // Explanation of the decode steps
      this.decodeSteps = textSYSTEM_TRAP(
        this.binFrags,
        this.binFragsOrdered,
        ISA[this.#mne].fmt,
        ISA[this.#mne].isa,
      ...
      // Steps for decoding in order
      this.binFragsOrdered.push(f['opcode'], f['csr'], f['funct3'], f['rd'], f['rs1'], f['csr']);

      // Explanation of the decode steps
      this.decodeSteps = textSYSTEM_ZICSR(
        this.binFrags,
        this.binFragsOrdered,
        ISA[this.#mne].fmt,
        ISA[this.#mne].isa,
  ...
  #decodeSTORE() {
    ...
    // Steps for decoding in order
    this.binFragsOrdered.push(f['opcode'], f['funct3'], f['rs1'], f['rs2'], f['imm_11_5'], f['imm_4_0']);

    // Explanation of the decode steps
    this.decodeSteps = textSTORE(
      this.binFrags,
      this.binFragsOrdered,
      ISA[this.#mne].fmt,
      ISA[this.#mne].isa,
  ...
  #decodeBRANCH() {
    ...
    // Steps for decoding in order
    this.binFragsOrdered.push(f['opcode'], f['funct3'], f['imm_12'], f['imm_11'], f['imm_10_5'], f['imm_4_1'], f['rs1'], f['rs2']);

    // Explanation of the decode steps
    this.decodeSteps = textBRANCH(
      this.binFrags,
      this.binFragsOrdered,
      ISA[this.#mne].fmt,
      ISA[this.#mne].isa,
  ...
  #decodeUType() {
    ...
    // Steps for decoding in order
    this.binFragsOrdered.push(f['opcode'], f['imm_31_12'], f['rd']);

    // Explanation of the decode steps
    this.decodeSteps = textUType(
      this.binFrags,
      this.binFragsOrdered,
      ISA[this.#mne].fmt,
      ISA[this.#mne].isa,
  ...
  #decodeJAL() {
    ...
    // Steps for decoding in order
    this.binFragsOrdered.push(f['opcode'], f['imm_20'], f['imm_19_12'], f['imm_11'], f['imm_10_1'], f['rd']);

    // Explanation of the decode steps
    this.decodeSteps = textJAL(
      this.binFrags,
      this.binFragsOrdered,
      ISA[this.#mne].fmt,
      ISA[this.#mne].isa,
  ...
  #decodeAMO() {
    ...
    // Steps for decoding in order
    this.binFragsOrdered.push(f['opcode'], f['funct5'], f['funct3'], f['rd'], f['rs1'], f['rs2'], f['aq'], f['rl']);

    // Explanation of the decode steps
    this.decodeSteps = textAMO(
      this.binFrags,
      this.binFragsOrdered,
      ISA[this.#mne].fmt,
      ISA[this.#mne].isa,
  ...
  #decodeR4() {
    ...
    // Steps for decoding in order
    this.binFragsOrdered.push(f['opcode'], f['fmt'], f['funct3'], f['rd'], f['rs1'], f['rs2'], f['rs3']);

    // Explanation of the decode steps
    this.decodeSteps = textR4(
      this.binFrags,
      this.binFragsOrdered,
      ISA[this.#mne].fmt,
      ISA[this.#mne].isa,
